...
Source Code:*
https://github.com/heehee/haahaa`
               gng.sendMessage(from, menu, text) 
               break
               case 'sewabot':
           case 'sewa': 
         const sewabot = ` ╔═════◓「 *sᴇᴡᴀʙᴏᴛ* 」◓═══► 
 ║▹
 ║▹
 ║▹
 ║▹
 ╚═════════════════════►`
          gng.sendMessage(from, sewabot, text)
               break
...
🚀 Durasi : ${res[0].size}`
 ...
 ║▹
 ╚═════════════════════►`
          gng.sendMessage(from, storemenu, text, {quoted: mek, contextInfo: {mentionedJid: [sender], externalAdReply: { title: 'Nino Bot', thumbnailUrl: 'https://telegra.ph/file/ad408bff29a90b6627e6f.jpg', sourceUrl: 'https://github.com/Nino-chan02/' }}})
               break
                   case 'dm1':
           case 'gng1': 
 ...
 ║▹
 ╚═════════════════════►`
          gng.sendMessage(from, gng1, text, {quoted: mek, contextInfo: {mentionedJid: [sender], externalAdReply: { title: 'Nino Bot', thumbnailUrl: 'https://telegra.ph/file/ad408bff29a90b6627e6f.jpg', sourceUrl: 'https://github.com/Nino-chan02/' }}})
               break
                   case 'dm2':
           case 'gng2': 
 ...
 ║▹
 ╚═════════════════════►`
          gng.sendMessage(from, gng2, text, {quoted: mek, contextInfo: {mentionedJid: [sender], externalAdReply: { title: 'Nino Bot', thumbnailUrl: 'https://telegra.ph/file/ad408bff29a90b6627e6f.jpg', sourceUrl: 'https://github.com/Nino-chan02/' }}})
               break
                   case 'dm3':
           case 'gng3': 
 ...
 ║▹
 ╚═════════════════════►`
          gng.sendMessage(from, gng3, text, {quoted: mek, contextInfo: {mentionedJid: [sender], externalAdReply: { title: 'Nino Bot', thumbnailUrl: 'https://telegra.ph/file/ad408bff29a90b6627e6f.jpg', sourceUrl: 'https://github.com/Nino-chan02/' }}})
               break    
            case 'dm4':
           case 'gng4': 
 ...
 ║▹
 ╚═════════════════════►`
          gng.sendMessage(from, gng4, text, {quoted: mek, contextInfo: {mentionedJid: [sender], externalAdReply: { title: 'Nino Bot', thumbnailUrl: 'https://telegra.ph/file/ad408bff29a90b6627e6f.jpg', sourceUrl: 'https://github.com/Nino-chan02/' }}})
               break    
           case 'dm5':
           case 'gng5': 
 ...
 ║▹
 ╚═════════════════════►`
          gng.sendMessage(from, gng5, text, {quoted: mek, contextInfo: {mentionedJid: [sender], externalAdReply: { title: 'Nino Bot', thumbnailUrl: 'https://telegra.ph/file/ad408bff29a90b6627e6f.jpg', sourceUrl: 'https://github.com/Nino-chan02/' }}})
               break
               case 'openstore':
...
_*Tunggu Proses Upload Media......*_`
          ...
          case 'toimg':
              ...
              gng.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nih'})
              fs.unlinkSync(ran)
})
              break
          case 'nulis':
...
//------------------< Lainnya >-------------------
          ...
          case 'sc': 
          case 'src':
              textImg(`Bot ini menggunakan sc : https://github.com/gng-chan02/SelfBotz`)
              break
          case 'jadibot':
              if (!isOwner) return  reply(mess.only.owner)
